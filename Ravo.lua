...
local themeStyles = {
    ...
    RAGE = {
        SchemeColor = Color3.fromRGB(255, 52, 52),
        Background = Color3.fromRGB(255, 104, 104),
        Header = Color3.fromRGB(255, 79, 79),
        TextColor = Color3.fromRGB(255,255,255),
        ElementColor = Color3.fromRGB(255, 52, 52)
    }
}
local oldTheme = ""
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "RAGE" then
        themeList = themeStyles.RAGE
    else
    ...
    blurFrame.Size = UDim2.new(0, 376, 0, 376)
    ...
    Main.Size = UDim2.new(0, 525, 0, 525)
